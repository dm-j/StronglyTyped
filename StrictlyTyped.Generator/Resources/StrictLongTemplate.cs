...
#endif
public readonly partial record struct ZYX : global::StrictlyTyped.IStrictLong<ZYX>
{
    /// <summary>
    ...
    private readonly static ZYX _zero = new(0L);
    ...
    public static implicit operator global::System.Int64(ZYX value) =>
        value.Value;
    ...
    /// </remarks>
    [global::System.Diagnostics.Contracts.Pure]
    public static implicit operator ZYX(global::System.Int64 value) =>
        new(value);
    ...
    public TResult Map<TResult>(global::System.Func<global::System.Int64, TResult> map) =>
        map(Value);

    public TStrictResult Map<TResult, TStrictResult>(global::System.Func<global::System.Int64, TResult> map) where TStrictResult : struct, global::StrictlyTyped.IStrictType<TStrictResult, TResult> =>
    ...
    private class Converter : global::System.ComponentModel.TypeConverter
    {
        ...
        static Converter()
        {
            _baseConverter = global::System.ComponentModel.TypeDescriptor.GetConverter(typeof(global::System.Int64));
        }
...
#if (USE_EF_CORE)
    public class EFConverter : global::Microsoft.EntityFrameworkCore.Storage.ValueConversion.ValueConverter<ZYX, global::System.Int64>
    {
