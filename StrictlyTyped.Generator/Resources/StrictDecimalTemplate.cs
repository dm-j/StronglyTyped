...
#endif
public readonly partial record struct ZYX : global::StrictlyTyped.IStrictDecimal<ZYX>
{
    /// <summary>
    ...
    public static implicit operator global::System.Decimal(ZYX value) =>
        value.Value;
    ...
    /// </remarks>
    [global::System.Diagnostics.Contracts.Pure]
    public static implicit operator ZYX(global::System.Decimal value) =>
        new(value);
    ...
    [global::System.Diagnostics.Contracts.Pure]
    public static ZYX operator ++(ZYX value) =>
        From(value.Value + (global::System.Decimal)1);
    ...
    public TResult Map<TResult>(global::System.Func<global::System.Decimal, TResult> map) =>
        map(Value);

    public TStrictResult Map<TResult, TStrictResult>(global::System.Func<global::System.Decimal, TResult> map) where TStrictResult : struct, global::StrictlyTyped.IStrictType<TStrictResult, TResult> =>
    ...
    private class Converter : global::System.ComponentModel.TypeConverter
    {
        ...
        static Converter()
        {
            _baseConverter = global::System.ComponentModel.TypeDescriptor.GetConverter(typeof(global::System.Decimal));
        }
...
#if (USE_EF_CORE)
    public class EFConverter : global::Microsoft.EntityFrameworkCore.Storage.ValueConversion.ValueConverter<ZYX, global::System.Decimal>
    {
