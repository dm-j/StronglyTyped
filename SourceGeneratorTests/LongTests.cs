...
{
    public partial class LongTests
    {
        [StrongLong] public partial record struct Test1;
        [StrongLong] public partial record struct Test2;
        ...
        {
            Test1 one = 1224L.As<Test1>();
            Test1 two = 1224L.As<Test1>();
