...
namespace SourceGeneratorTests
{
    ...
    {
        [StrongSByte] public partial record struct Test1;
        [StrongSByte] public partial record struct Test2;
        ...
        {
            Test1 one = ((sbyte)122).As<Test1>();
            Test1 two = ((sbyte)122).As<Test1>();
        ...
        {
            Test1 one = ((sbyte)7).As<Test1>();
            Test1 two = ((sbyte)122).As<Test1>();
            Test1 three = ((sbyte)122).As<Test1>();
        ...
        {
            List<Test1> list = Enumerable.Range(0, 10).Select(v => Test1.From((sbyte)v)).ToList();
